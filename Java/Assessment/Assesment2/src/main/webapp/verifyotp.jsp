          ...
          <div class="col-md-8 block-9 mb-md-5">
            <form action="studentcontroller" class="bg-light p-5 contact-form" method="post">
              ...
              <div class="form-group">
                <input type="text" name="otp2" class="form-control" placeholder="Enter otp">
              </div>           
              <div class="form-group">
                <input type="submit" name="action" value="verify" class="btn btn-primary py-3 px-5">
              </div>
