  ...
  <%String msg=(String)request.getAttribute("msg"); %>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <%if(msg!=null){ %>
                <h3 class="d-inline-block text-primary text-uppercase border-bottom border-5"><%out.print(msg); %></h3>
               <%} %>
            </div>
        <div>
            ...
            <div class="row justify-content-center position-relative" style="margin-top: -200px; z-index: 1;">
              ...
              <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5"><a href="d-forget-password.jsp">Forgot Password ?</a></h5>
            </div>
        </div>
    </div>
    <!-- Contact End -->
